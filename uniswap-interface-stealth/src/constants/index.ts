import { ChainId, JSBI, Percent, Token, WDEV } from 'stealthswap'
import { AbstractConnector } from '@web3-react/abstract-connector'

import { injected, walletconnect } from '../connectors'
//fortmatic, portis, walletconnect, walletlink, lattice
export const ROUTER_ADDRESS: { [key: string]: string } = {
  [ChainId.MODEMAIN]: '0x8b0d1D3557aF524351FCd09eE8E7a48adcB712e0',
  [ChainId.MODESEPOLIA]: '0x8b0d1D3557aF524351FCd09eE8E7a48adcB712e0',
}
...
const WDEV_ONLY: ChainTokenList = {
  ...
  [ChainId.MODESEPOLIA]: [WDEV[ChainId.MODESEPOLIA]],
  [ChainId.MODEMAIN]: [WDEV[ChainId.MODEMAIN]],
}
